...
![Filament Teams](https://raw.githubusercontent.com/jeffersongoncalves/filament-teams/1.x/art/jeffersongoncalves-filament-teams.png)
...
[![GitHub Tests Action Status](https://img.shields.io/github/actions/workflow/status/jeffersongoncalves/filament-teams/tests.yml?branch=1.x&label=tests&style=flat-square)](https://github.com/jeffersongoncalves/filament-teams/actions?query=workflow%3Atests+branch%3A1.x)
[![GitHub Code Style Action Status](https://img.shields.io/github/actions/workflow/status/jeffersongoncalves/filament-teams/fix-php-code-style-issues.yml?branch=1.x&label=code%20style&style=flat-square)](https://github.com/jeffersongoncalves/filament-teams/actions?query=workflow%3A"Fix+PHP+code+styling"+branch%3A1.x)
...
```bash
composer require jeffersongoncalves/filament-teams:"^1.0"
```
